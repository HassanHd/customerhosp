...
class HealthCareFour extends StatefulWidget {
  const HealthCareFour({Key? key}) : super(key: key);

  @override
  _HealthCareFourState createState() => _HealthCareFourState();
}

class _HealthCareFourState extends State<HealthCareFour> {
  File? imageFile;
  var base64Imageteam;
