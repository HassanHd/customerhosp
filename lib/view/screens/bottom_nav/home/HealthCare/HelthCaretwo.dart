...
import 'HelthCareAddress.dart';
import 'HelthCarethree.dart';
class HelthCaretwo extends StatefulWidget {
String idMedicalSpecialty;
String MedicalSpecialty;


  @override
  _HelthCaretwoState createState() => _HelthCaretwoState();
...
class _HelthCaretwoState extends State<HelthCaretwo> {
  ...
  @override
  void initState() {
    print("MedicalSpecialty  ${widget.MedicalSpecialty}");
    print("${widget.idMedicalSpecialty}");
    getLocation();
    super.initState();
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => HelthCareAddress(longitude: '${currentPosition!.longitude}', idMedicalSpecialty: '${widget.idMedicalSpecialty}',MedicalSpecialty: '${widget.MedicalSpecialty}',latitude: '${currentPosition!.latitude}',)),
                    );
                  },
                ),
