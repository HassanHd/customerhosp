...
import 'HomeVisitAddress.dart';

class HomeVisitTwo extends StatefulWidget {
  String idMedicalSpecialty;
  String MedicalSpecialty;
  @override
  _HomeVisitTwoState createState() => _HomeVisitTwoState();
...
class _HomeVisitTwoState extends State<HomeVisitTwo> {
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => HomeVisitAddress(longitude: '${currentPosition!.longitude}', idMedicalSpecialty: '${widget.idMedicalSpecialty}',MedicalSpecialty: '${widget.MedicalSpecialty}',latitude: '${currentPosition!.latitude}',)),
                    );
                  },
                ),
