...
class Ambulancethree extends StatefulWidget {
  ...
  @override
  _AmbulancethreeState createState() => _AmbulancethreeState();

}

class _AmbulancethreeState extends State<Ambulancethree> {
