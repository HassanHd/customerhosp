...
class AddPationhistory extends StatefulWidget {
  const AddPationhistory({Key? key}) : super(key: key);

  @override
  _AddPationhistoryState createState() => _AddPationhistoryState();
}

class _AddPationhistoryState extends State<AddPationhistory> {
  File? imageFile;
  var base64Imageteam;
                ...
                child: CustomButton(
                  ...
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      Provider.of<UploadAttachmentControler>(context, listen: false).fetchUploadAttachment(field: value, title: _TitleController.text.toString(), description: _disController.text.toString(), attached_file: base64Imageteam).then((value){
