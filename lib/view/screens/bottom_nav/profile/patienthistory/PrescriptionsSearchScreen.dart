...
class PrescriptionsSearchScreen extends StatefulWidget {
  const PrescriptionsSearchScreen({Key? key}) : super(key: key);

  @override
  _PrescriptionsSearchScreenState createState() =>
      _PrescriptionsSearchScreenState();
}

class _PrescriptionsSearchScreenState extends State<PrescriptionsSearchScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: ControllerHistory.getHistory("Prescriptions"),
